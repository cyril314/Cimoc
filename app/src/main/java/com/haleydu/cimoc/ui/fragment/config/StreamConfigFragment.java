...
//        }
    ...
    void onReaderEventClick(View view) {
        ...
        Intent intent = EventSettingsActivity.createIntent(getActivity(), isLong, mReaderOrientation.getValue(), true);
...
//        ItemDialogFragment fragment = ItemDialogFragment.newInstance(R.string.common_operation_select, items, DIALOG_REQUEST_OPERATION);
