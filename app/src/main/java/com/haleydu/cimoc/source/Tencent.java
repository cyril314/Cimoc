...
public class Tencent extends MangaParser {
    ...
    public static final String HOST_STR = "m.ac.qq.com";
    ...
    public Request getSearchRequest(String keyword, int page) throws UnsupportedEncodingException {
        String url = URL_STR + "/search/result?word=%s".concat(keyword);
    ...
    public String getUrl(String cid) {
        return URL_STR + "/Comic/ComicInfo/id/".concat(cid);
    }
    ...
    public Request getInfoRequest(String cid) {
        String url = URL_STR + "/comic/index/id/".concat(cid);
        return HttpUtils.getSimpleMobileRequest(url);
    }
    ...
    public Request getChapterRequest(String html, String cid) {
        String url = URL_STR + "/comic/chapterList/id/".concat(cid);
        return HttpUtils.getSimpleMobileRequest(url);
    }
    ...
    public Request getImagesRequest(String cid, String path) {
        String url = StringUtils.format(URL_STR + "/chapter/index/id/%s/cid/%s", cid, path);
        return HttpUtils.getSimpleMobileRequest(url);
    }
    ...
    private String decodeData(String str, String nonce) {
        ...
        while ((len--) != 0) {
            str = splice(str, Integer.parseInt(StringUtils.match("^\\d+", matches.get(len), 0)) & 255,
    ...
    public List<ImageUrl> parseImages(String html, Chapter chapter) {
        ...
        String str = StringUtils.match("data-src:\\s*'(.*)?',", html, 1);
        if (str != null) {
            try {
