...
public class PuFei extends MangaParser {
    ...
    public static final String HOST_STR = "m.pufei6.top";
    ...
    public Request getSearchRequest(String keyword, int page) throws UnsupportedEncodingException {
        String url = "";
        if (page == 1) {
            url = StringUtils.format(URL_STR + "/e/search/?searchget=1&tbname=mh&show=title,player,playadmin,bieming,pinyin,playadmin&tempid=4&keyboard=%s",
    ...
    public String getUrl(String cid) {
        return URL_STR + "/manhua/".concat(cid);
    }
    ...
    private static class Category extends MangaCategory {
        ...
        public String getFormat(String... args) {
            return StringUtils.format(URL_STR + "/act/?act=list&page=%%d&catid=%s&ajax=1&order=%s",
