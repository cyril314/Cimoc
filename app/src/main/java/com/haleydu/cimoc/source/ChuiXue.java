...
public class ChuiXue extends MangaParser {
    ...
    public static final String HOST_STR = "www.chuixue.net";
    ...
    public Request getSearchRequest(String keyword, int page) throws UnsupportedEncodingException {
        String url = "";
        if (page == 1) {
            url = StringUtils.format(URL_STR + "/e/search/?searchget=1&show=title,player,playadmin,pinyin&keyboard=%s",
    ...
    public Headers getHeader() {
        String referer = StringUtils.format(URL_STR + "/manhua/%s/%s.html", _cid, _path);
