...
public class Cartoonmad extends MangaParser {
    ...
    public static final String HOST_STR = "www.cartoonmad.com";
    ...
    public Request getSearchRequest(String keyword, int page) throws UnsupportedEncodingException {
        ...
        String url = URL_STR + "/search.html";
        RequestBody body = new FormBody.Builder()
                .add("keyword", URLEncoder.encode(keyword, "BIG5"))
                .add("searchtype", "all").build();
        return HttpUtils.getMobileRequest(url).post(body).addHeader("Referer", URL_STR).build();
    }
    ...
    public SearchIterator getSearchIterator(String html, int page) {
        ...
        return new RegexIterator(matcher) {
            ...
            protected Comic parse(Matcher match) {
                ...
                String cover = URL_STR + match.group(3);
...
//                String author = node.text("dl:eq(2) > dd");
    ...
    public String getUrl(String cid) {
        return URL_STR + "/comic/".concat(cid).concat(".html");
    }
    ...
    public Request getInfoRequest(String cid) {
        String url = URL_STR + "/comic/".concat(cid).concat(".html");
    ...
    public Comic parseInfo(String html, Comic comic) throws UnsupportedEncodingException {
        ...
        String cover = mCover.find() ? URL_STR + mCover.group(1) : "";
        String update = "";
        String author = "";
    ...
    public Request getImagesRequest(String cid, String path) {
        String url = StringUtils.format(URL_STR + "/%s", path);
        _cid = cid;
        _path = path;
        return HttpUtils.getSimpleMobileRequest(url);
    }
    ...
    public List<ImageUrl> parseImages(String html, Chapter chapter) {
        ...
        for (int i = 1; i <= page; ++i) {
            ...
            list.add(new ImageUrl(id, comicChapter, i, StringUtils.format(URL_STR + "/comic/%s%03d.html", pageMatcher.group(1), i), true));
        }
        return list;
    }
    ...
    public Request getLazyRequest(String url) {
        return HttpUtils.getMobileRequest(url, "Referer", url);
    }
