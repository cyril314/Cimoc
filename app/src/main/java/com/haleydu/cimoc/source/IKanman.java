...
public class IKanman extends MangaParser {
    ...
    public static final String HOST_STR = "www.manhuagui.com";
...
//        init(source, new Category());
    ...
    public Request getSearchRequest(String keyword, int page) {
        String url = StringUtils.format(URL_STR + "/s/%s_p%d.html", keyword, page);
...
//                String md5 = object.getJSONObject("sl").getString("md5");
    ...
    public Headers getHeader() {
        return Headers.of("Referer", referer, "User-Agent", HttpUtils.getHeadStr());
    }
...
//            return StringUtils.format(URL_STR+"/list/%s/%s_p%%d.html", path, args[CATEGORY_ORDER]);
//        }
//
//        @Override
