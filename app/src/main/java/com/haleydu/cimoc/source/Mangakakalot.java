...
public class Mangakakalot extends MangaParser {
    ...
    public static final String HOST_STR = "mangakakalot.com";
    ...
    public Request getSearchRequest(String keyword, int page) {
        ...
        String url = URL_STR + "/search/story/" + keyword;
        return HttpUtils.getMobileRequest(url, "Referer", URL_STR + "/");
    }
    ...
    public Request getInfoRequest(String cid) {
        return HttpUtils.getMobileRequest(cid, "Referer", URL_STR + "/");
    }
     ...
     * 才能获取 ，这些情况一般可以根据页码构造出相应的请求链接，到阅读时再解析
    ...
    public List<Comic> parseCategory(String html, int page) {
        ...
        if (page <= total) {
            for (Node node : body.list("div.truyen-list > div.list-truyen-item-wrap")) {
                String cid = node.href("h3 > a").replace(URL_STR + "/manga/", "");
