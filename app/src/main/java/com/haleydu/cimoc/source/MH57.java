...
public class MH57 extends MangaParser {
    ...
    private static final String TAG = MH57.class.getSimpleName();

    public static final int TYPE = 8;
    public static final String DEFAULT_TITLE = "57漫画";
    public static final String HOST_STR = "m.wuqimh.com";
    ...
    public Request getSearchRequest(String keyword, int page) {
        String url = StringUtils.format(URL_STR + "/search/q_%s-p-%d", keyword, page);
    ...
    private static class Category extends MangaCategory {
        ...
        public String getFormat(String... args) {
            return StringUtils.format(URL_STR + "/list/area-%s-smid-%s-year-%s-lz-%s-order-%s-p-%%d",
