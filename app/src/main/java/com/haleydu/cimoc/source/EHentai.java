...
public class EHentai extends MangaParser {
    ...
    public static final String HOST_STR = "e-hentai.org";
    ...
    public Request getSearchRequest(String keyword, int page) {
        String url = "";
        if (page == 1)
            url = StringUtils.format(URL_STR + "/?f_doujinshi=1&f_manga=1&f_artistcg=1&f_gamecg=1&f_western=1&f_non-h=1&f_imageset=1&f_cosplay=1&f_asianporn=1&f_misc=1&f_search=%s&f_apply=Apply+Filter", keyword);
    ...
    public Request getInfoRequest(String cid) {
        String url = StringUtils.format(URL_STR + "/g/%s", cid);
...
//    }
    ...
    public Request getImagesRequest(String cid, String path) {
        String url = StringUtils.format(URL_STR + "/g/%s/?p=%s", cid, path);
        return new Request.Builder().url(url).header("Cookie", "nw=1").build();
    }
