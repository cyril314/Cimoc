...
import com.haleydu.cimoc.parser.*;
...
public class MH50 extends MangaParser {
    ...
    public static final String URL_STR = "https://m.manhuadai.com";
    ...
    public Request getSearchRequest(String keyword, int page) {
        if (page == 1) {
            String url = StringUtils.format(URL_STR + "/search/?keywords=%s&page=%d", keyword, page);
    ...
    public String getUrl(String cid) {
        return StringUtils.format(URL_STR + "/manhua/%s/", cid);
    }
    ...
    public Request getInfoRequest(String cid) {
        String url = StringUtils.format(URL_STR + "/manhua/%s/", cid);
        return HttpUtils.getSimpleMobileRequest(url);
    }
    ...
    public Request getImagesRequest(String cid, String path) {
        String url = StringUtils.format(URL_STR + "/manhua/%s/%s", cid, path);
        return HttpUtils.getSimpleMobileRequest(url);
    }
    ...
    public List<ImageUrl> parseImages(String html, Chapter chapter) {
        ...
        try {
            JSONArray imageList = JsonUtils.jsonStr2JsonArray(arrayStringCode);
    ...
    private static class Category extends MangaCategory {
        ...
        public String getFormat(String... args) {
            ...
            String finalPath;
            if (path.isEmpty()) {
                finalPath = StringUtils.format(URL_STR + "/list/");
            } else {
                finalPath = StringUtils.format(URL_STR + "/list/%s/?page=%%d", path).replaceAll("\\s+", "-");
            }
            return finalPath;
        }
