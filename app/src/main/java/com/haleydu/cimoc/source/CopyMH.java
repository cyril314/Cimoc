...
public class CopyMH extends MangaParser {
    ...
    public static final String HOST_STR = "copymanga.site";
...
//            keyword = jChineseConvertor.s2t(keyword);
            url = StringUtils.format("https://api." + HOST_STR + "/api/v3/search/comic?platform=1&limit=30&offset=0&q=%s", keyword);
    ...
    public String getUrl(String cid) {
        return URL_STR + "/h5/details/comic/".concat(cid);
    }
    ...
    public Request getInfoRequest(String cid) {
        String url = "https://api." + HOST_STR + "/api/v3/comic2/".concat(cid);
        return HttpUtils.getSimpleMobileRequest(url);
    }
    ...
    public Request getChapterRequest(String html, String cid) {
        String url = String.format("https://api." + HOST_STR + "/api/v3/comic/%s/group/default/chapters?limit=500&offset=0", cid);
        return HttpUtils.getSimpleMobileRequest(url);
    }
    ...
    public List<Chapter> parseChapter(String html, Comic comic, Long sourceComic) throws JSONException {
        ...
        try {
            ...
            while (keys.hasNext()) {
                ...
                Request request = HttpUtils.getSimpleMobileRequest(url);
    ...
    public Request getImagesRequest(String cid, String path) {
        String url = StringUtils.format(URL_STR + "/comic/%s/chapter/%s", cid, path);
        return HttpUtils.getSimpleMobileRequest(url);
    }
