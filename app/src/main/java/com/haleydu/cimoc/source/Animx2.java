...
public class Animx2 extends MangaParser {
    ...
    public Request getInfoRequest(String cid) {
        ...
        return HttpUtils.getMobileRequest(cid, "Cookie", "isAdult=1");
    }
    ...
    public Request getImagesRequest(String cid, String path) {
        ...
        _cid = cid;
        _path = path;
        return HttpUtils.getMobileRequest(path, "Cookie", "isAdult=1");
    }
    ...
    public Request getLazyRequest(String url) {
        return HttpUtils.getMobileRequest(url, "Cookie", "isAdult=1");
    }
