...
public class DM5 extends MangaParser {
    ...
    public static final String HOST_STR = "www.dm5.com";
    ...
    public Request getSearchRequest(String keyword, int page) {
        String url = URL_STR + "/pagerdata.ashx";
    ...
    public Request getImagesRequest(String cid, String path) {
        ...
        return new Request
                .Builder()
                .addHeader("Referer", StringUtils.format(URL_STR + "/%s", path))
                .url(url).build();
    }
    ...
    public Request getLazyRequest(String url) {
        return new Request.Builder().url(url).addHeader("Referer", URL_STR).build();
    }
    ...
    public Headers getHeader(String url) {
        ...
        return Headers.of("Referer", URL_STR + "/".concat(cid));
    }
    ...
    private static class Category extends MangaCategory {
        ...
        public String getFormat(String... args) {
            ...
            return StringUtils.format(URL_STR + "/m%s-p%%d", path);
        }
