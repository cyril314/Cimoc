...
public class DBOpenHelper extends DaoMaster.OpenHelper {
    ...
    private void updateIntroAndAuthor(Database db) {
        ...
        db.execSQL("ALTER TABLE `COMIC` RENAME TO `COMIC2`");
        ComicDao.createTable(db, false);
        db.execSQL("INSERT INTO `COMIC` (`_id`, `SOURCE`, `CID`, `TITLE`, `COVER`, `UPDATE`, `HIGHLIGHT`, `LOCAL`, " +
                "`FAVORITE`, `HISTORY`, `DOWNLOAD`, `LAST`,  `PAGE`, `CHAPTER`, `INTRO`, `AUTHOR`) SELECT `_id`, " +
                "`SOURCE`, `CID`, `TITLE`, `COVER`, `UPDATE`, `HIGHLIGHT`, `LOCAL`, `FAVORITE`, `HISTORY`, `DOWNLOAD`, " +
    ...
    private void updateSource(Database db) {
        ...
        SourceDao.createTable(db, false);
        db.execSQL("INSERT INTO `SOURCE` (`_id`, `TYPE`, `TITLE`, `ENABLE`) SELECT `_id`, `TYPE`, `TITLE`, `ENABLE` FROM `SOURCE2`");
    ...
    private void updateDownload(Database db) {
        ...
        db.execSQL("ALTER TABLE `COMIC` RENAME TO `COMIC2`");
        ComicDao.createTable(db, false);
        db.execSQL("INSERT INTO `COMIC` (`_id`, `SOURCE`, `CID`, `TITLE`, `COVER`, `HIGHLIGHT`, `UPDATE`, `FINISH`, " +
                "`FAVORITE`,`HISTORY`, `DOWNLOAD`, `LAST`, `PAGE`)  SELECT `_id`, `SOURCE`, `CID`, `TITLE`, `COVER`, " +
                "`HIGHLIGHT`, `UPDATE`, null, `FAVORITE`, `HISTORY`, null, `LAST`, `PAGE` FROM `COMIC2`");
        db.execSQL("DROP TABLE `COMIC2`");
        db.setTransactionSuccessful();
        db.endTransaction();
    }
    ...
    private void updateHighlight(Database db) {
        ...
        db.execSQL("ALTER TABLE `COMIC` RENAME TO `COMIC2`");
        ComicDao.createTable(db, false);
        db.execSQL("INSERT INTO `COMIC` (`_id`, `SOURCE`, `CID`, `TITLE`, `COVER`, `UPDATE`, `HIGHLIGHT`, `FAVORITE`, " +
                "`HISTORY`, `LAST`, `PAGE`) SELECT `_id`, `SOURCE`, `CID`, `TITLE`, `COVER`, `UPDATE`, 0, `FAVORITE`, " +
                "`HISTORY`, `LAST`, `PAGE` FROM `COMIC2`");
        db.execSQL("DROP TABLE `COMIC2`");
